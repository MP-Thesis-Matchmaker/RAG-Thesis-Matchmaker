...
| `names.py` | Person-name canonicalisation: title stripping, `"Family, Given"` flipping, and two folds. Here because the scraper cleans names on the way in and the matcher compares them across sources, and one title vocabulary in two places drifts |
